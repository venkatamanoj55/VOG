...
class Mychinese extends StatelessWidget {
  const Mychinese({Key? key}) : super(key: key);
...
class SpiceList extends StatelessWidget {
  final List<Spice> spices = [
    Spice(
      name: 'Manchuriya',
      price: 'Rs 150.00',
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8chp3YWw8M8RwgM7qaHzI7zOcFXKU0IVLUw&usqp=CAU',
    ),
    Spice(
      name: 'Noodles',
      price: 'Rs 150.00',
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQygFdte7qy-Mc3zxP9xbLmqxg_qRVA8Jxgyg&usqp=CAU',
    ),
    Spice(
      name: 'momos',
      price: 'Rs 150.00',
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6uPEjPDB5T2gdnkPZ-sVcI5OSfRPld9BsJA&usqp=CAU',
    ),
    Spice(
      name: 'fried rice',
      price: 'Rs 150.00',
