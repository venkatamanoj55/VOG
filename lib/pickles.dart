...
class Mypickles extends StatelessWidget {
  const Mypickles({Key? key}) : super(key: key);
...
class SpiceList extends StatelessWidget {
  final List<Spice> spices = [
    Spice(
      name: 'Avakaya pickle',
      price: 'Rs 150.00',
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaz_bEQl4d87ahOqqFaQE396BwcbMHUZF17Q&usqp=CAU',
    ),
    Spice(
      name: 'tomato pickle',
      price: 'Rs 150.00',
